...
<div class="container">
    ...
    <table class="items-table">
        ...
        <tbody>
            ...
            <tr>
                <td style="font-family: monospace; font-weight:600;">{{ $row['Order #'] }}</td>
                <td>{{ $row['Date'] }}</td>
                <td>{{ $row['Customer'] }}</td>
                <td>{{ $row['Location'] }}</td>
                ...
                <td style="text-align:right; {{ $row['Balance (৳)'] !== '0' ? 'color:#dc2626;font-weight:600;' : '' }}">{{ $row['Balance (৳)'] }}</td>
                <td>{{ $row['Payment'] }}</td>
                <td>{{ $row['Status'] }}</td>
            </tr>
            ...
            <table class="items-table"><thead><tr>
                <th>Order #</th><th>Date</th><th>Customer</th><th>Location</th>
