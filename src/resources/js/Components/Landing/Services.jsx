...
const services = [
    {
        title: 'Photo Studio',
        description:
            'Official passport and visa photos for all countries. We know the exact biometric specifications for USA, UK, Canada, Schengen, Australia, Saudi Arabia, UAE, Japan, and 100+ countries.',
        features: [
    ...
    },
    {
        title: 'Photo Reprint',
        description:
            'Reorder prints anytime using your unique FDCL Photo ID. No studio visit needed — upload from your phone, Google Drive, or Dropbox, and we deliver to you.',
        features: [
    ...
    },
    {
        title: 'Photo Album',
        description:
            'Premium handcrafted photo albums for weddings, graduations, family portraits, and travel memories. Custom layouts, premium binding, and archival-quality paper.',
        features: [
    ...
    },
    {
        ...
        description:
            'Transform your cherished photos into wall art with our professional framing service. Perfect for homes, offices, wedding gifts, and corporate décor.',
        features: [
    ...
    },
    {
        ...
        description:
            'Personalized ceramic mugs with your photos — ideal for gifts, corporate promotions, and branded merchandise. Vibrant full-color printing that lasts.',
        features: [
    ...
    },
    {
        title: 'Print Service',
        description:
            'Walk in with your photos or documents — walk out with professional prints. Any size, any paper type, colour or B&W. No appointment needed.',
        features: [
            ...
            <div className="mx-auto max-w-7xl">
                <FadeIn className="text-center">
                    ...
                    <p className="mx-auto mt-4 max-w-2xl text-lg text-gray-600 dark:text-gray-300">
                        From instant passport photos to custom wedding albums — professional quality, fast turnaround, at our Bailey Road and Gulshan studios in Dhaka.
                    </p>
                    <div className="mt-4 inline-flex items-center gap-2 rounded-full border border-green-200 bg-green-50 px-4 py-1.5 text-sm font-medium text-green-700 dark:border-green-800 dark:bg-green-900/20 dark:text-green-400">
                        ...
                        bKash payment accepted at both studios
                    </div>
                </FadeIn>
