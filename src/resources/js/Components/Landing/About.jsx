            ...
            <div className="mx-auto max-w-7xl">
                <div className="grid items-start gap-12 lg:grid-cols-2 lg:gap-16">
                    <div className="relative">
                        ...
                        <div className="absolute -top-4 -left-4 hidden rounded-2xl bg-primary p-4 shadow-lg sm:block">
                            <div className="text-center text-white">
                                <div className="text-3xl font-extrabold leading-none">{t.about.experienceValue}</div>
                                <div className="mt-0.5 text-xs font-medium opacity-90" dangerouslySetInnerHTML={{ __html: t.about.experienceLabel }} />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="sm:pt-4">
                        ...
                        <p className="mt-5 text-lg leading-relaxed text-gray-600 dark:text-gray-300" dangerouslySetInnerHTML={{ __html: t.about.p1 }} />

                        <p className="mt-4 text-base leading-relaxed text-gray-600 dark:text-gray-300" dangerouslySetInnerHTML={{ __html: t.about.p2 }} />
