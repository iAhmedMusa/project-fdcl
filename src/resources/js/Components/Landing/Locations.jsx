        ...
        <section id="locations" className="relative overflow-hidden bg-white dark:bg-gray-900 px-4 py-20 sm:px-6 lg:py-24">
            ...
            <div className="relative mx-auto max-w-7xl">
                <div className="text-center">
                    <span className="inline-flex items-center gap-2 rounded-full bg-white dark:bg-gray-800 px-4 py-1.5 text-sm font-semibold text-primary border border-border dark:border-gray-700">
                ...
                <div className="mt-12 rounded-2xl bg-gradient-to-r from-secondary/5 to-primary/5 dark:from-secondary/10 dark:to-primary/10 p-8 text-center border border-border dark:border-gray-700">
                    <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="rounded-lg bg-primary px-6 py-3 font-semibold text-white shadow-sm transition-all hover:bg-primary/80 hover:shadow-md"
                        >
                            Read Reviews
                        </a>
                    </div>
