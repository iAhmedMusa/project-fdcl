        ...
        <section id="contact" className="relative overflow-hidden bg-gradient-to-br from-white via-light to-surface dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 px-4 py-20 sm:px-6 lg:py-24">
            ...
            <div className="relative mx-auto max-w-7xl">
                <div className="text-center">
                    <div className="inline-flex items-center gap-2 rounded-full bg-white dark:bg-gray-800 px-4 py-1.5 text-sm font-semibold text-secondary border border-border dark:border-gray-700">
                    ...
                    <div className="mt-12 flex flex-col items-center gap-6 sm:flex-row sm:justify-center sm:gap-8">
                        ...
                        >
                            <div className="flex h-12 w-12 items-center justify-center rounded-full bg-secondary/10 text-secondary group-hover:bg-secondary group-hover:text-white">
                    ...
                    <div className="mt-12">
                        <Link
                            href="/order"
                            className="inline-flex items-center gap-3 rounded-xl bg-primary px-8 py-4 font-bold text-white shadow-md transition-all hover:bg-accent hover:shadow-lg"
                        >
                            <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                                <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 3h15a.75.75 0 0 1 .75.75v15a.75.75 0 0 1-.75.75H2.25a.75.75 0 0 1-.75-.75V3.75A.75.75 0 0 1 2.25 3Z" />
...
<div className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    <div className="flex items-start gap-4 rounded-xl bg-white dark:bg-gray-800 border border-border dark:border-gray-700 p-5 shadow-sm">
                        <svg className="h-6 w-6 shrink-0 text-secondary" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
