...
const trustPoints = [
    {
        ...
        description: "Not happy? We retake your photo at zero extra cost.",
        icon: (
    ...
    {
        title: 'Embassy-Accepted Photos',
        description: 'All visa & passport photos meet international biometric standards.',
        icon: (
            <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    {
        title: 'FDCL Photo ID',
        description: 'Reorder your photos online anytime — no studio visit needed.',
        icon: (
            <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    {
        title: 'bKash Payment Accepted',
        description: 'Pay conveniently at the studio via bKash — no cash needed.',
        icon: (
            <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            ...
            <div className="relative mx-auto max-w-7xl">
                ...
                <div className="text-center">
                    ...
                    <p className="mx-auto mt-5 max-w-2xl text-lg text-gray-400">
                        Two studios in Dhaka — Bailey Road &amp; Gulshan. Walk in anytime or book online. Photos ready in 10 minutes.
                    </p>
                    ...
                    <div className="mt-8 inline-flex items-center gap-3 rounded-2xl border border-white/10 bg-white/5 px-6 py-3 backdrop-blur-sm">
                        ...
                        <div className="text-left">
                            <span className="block text-sm font-semibold text-white">Sat–Thu 9:30 AM – 9:00 PM</span>
                            <span className="block text-xs text-gray-400">Friday 3:00 PM – 9:00 PM</span>
                        </div>
                    </div>
                </div>
