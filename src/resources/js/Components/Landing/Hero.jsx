...
export default function Hero() {
    ...
    const highlights = [
        ...
        {
            title: t.hero.highlight4Title,
            sub: t.hero.highlight4Sub,
            icon: (
            ...
            <div className="relative mx-auto max-w-7xl px-4 py-10 sm:px-6 sm:py-16 lg:px-8 lg:py-24">
                <div className="grid items-center gap-8 lg:grid-cols-2 lg:gap-16">
                    ...
                    <div>
                        ...
                        <p className="mb-6 max-w-xl text-base leading-relaxed text-gray-600 dark:text-gray-300 sm:mb-8 sm:text-lg lg:text-xl" dangerouslySetInnerHTML={{ __html: t.hero.body }} />
                        ...
                        <div className="relative overflow-hidden rounded-2xl shadow-2xl">
                            ...
                            <div className="absolute bottom-3 left-3 rounded-xl bg-white/95 px-3 py-2 shadow-lg backdrop-blur-sm dark:bg-gray-900/95 sm:bottom-4 sm:left-4 sm:px-4 sm:py-2.5">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-xs font-semibold text-gray-800 dark:text-white sm:text-sm">{t.hero.photoBadge}</span>
                                </div>
                            </div>
                        </div>
