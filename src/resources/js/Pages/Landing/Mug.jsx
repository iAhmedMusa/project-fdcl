            ...
            <div className="mx-auto max-w-2xl px-4 pt-32 pb-16">
                ...
                <div className="max-w-xl">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="rounded-lg border bg-card p-5">
                            ...
                            {activeTab === 'upload' && (
                                <div className="mt-4">
                                    ...
                                    {!uploadedFile ? (
                                        <button type="button" onClick={() => fileInputRef.current?.click()} className="w-full rounded-lg border-2 border-dashed border-gray-300 p-8 text-center hover:border-gray-400 dark:border-gray-600 dark:hover:border-gray-500">
                                        ...
                                        <div className="relative">
                                            ...
                                            <button type="button" onClick={removeFile} className="absolute top-2 right-2 rounded-lg bg-red-500 px-2 py-1 text-xs font-medium text-white hover:bg-red-600">
                                                Remove
                                            </button>
                                        </div>
                                    )}
                        ...
                        <div className="rounded-lg border bg-card p-5">
                            <h2 className="mb-4 text-base font-semibold text-gray-900 dark:text-gray-100">Note for Mug <span className="font-normal text-gray-400">(Optional)</span></h2>
                            <textarea
                                value={itemNotes}
