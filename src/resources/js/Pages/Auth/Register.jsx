...
function Field({ id, label, error, prefix, suffix, children }) {
    return (
...
const inputCls = (hasPre, hasSuf) =>
    `block w-full rounded-lg border border-input bg-background py-2.5 text-sm text-foreground placeholder:text-muted-foreground focus:border-ring focus:outline-none focus:ring-2 focus:ring-ring/20 ${hasPre ? 'pl-9' : 'pl-3'} ${hasSuf ? 'pr-10' : 'pr-3'}`;
...
export default function Register() {
    ...
    const emailForm = useForm({ method: 'email', name: '', email: '', phone: '', address: '', password: '', password_confirmation: '' });
    const phoneForm = useForm({ method: 'phone', name: '', phone: '', address: '', password: '', password_confirmation: '' });

    const form = tab === 'email' ? emailForm : phoneForm;
        ...
        <GuestLayout>
            ...
            <div className="space-y-5">
                ...
                <div>
                    ...
                    <p className="mt-1 text-sm text-muted-foreground">Join Focus Lab to manage your photo orders</p>
                </div>
                ...
                <form onSubmit={submit} className="space-y-4">
                    ...
                    {/* Optional phone (email tab only) */}
                    {tab === 'email' && (
                        <Field
                            id="phone_opt"
                            label="Phone (optional)"
                            error={emailForm.errors.phone}
                            prefix={
                                <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z" />
                                </svg>
                        ...
                        >
                            <input
                                ...
                                type="tel"
                                name="phone"
                                value={emailForm.data.phone}
                                autoComplete="tel"
                                onChange={(e) => emailForm.setData('phone', e.target.value)}
                                className={inputCls(true, false)}
                                placeholder="+880 1XXX-XXXXXX"
                            />
                        </Field>
                    ...
                    <div className="space-y-1.5">
                        ...
                        <textarea
                            ...
                            className="block w-full rounded-lg border border-input bg-background px-3 py-2.5 text-sm text-foreground placeholder:text-muted-foreground focus:border-ring focus:outline-none focus:ring-2 focus:ring-ring/20 resize-none"
