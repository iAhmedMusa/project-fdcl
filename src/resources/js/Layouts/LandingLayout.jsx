                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="flex h-20 items-center justify-between">
                        ...
                        <div className="hidden md:flex items-center gap-3">
                            ...
                            <Link
                                href="/order"
                                className="rounded-lg bg-primary px-5 py-2.5 text-sm font-bold text-white shadow-sm transition-all hover:bg-accent hover:shadow-md"
                            >
                                Order Now
                            </Link>
                        </div>
                    ...
                    <div className="grid gap-8 md:grid-cols-4">
                        <div className="md:col-span-2">
                            ...
                            <div className="mt-6 flex gap-6">
                                <a
                                    ...
                                    className="flex items-center gap-2 text-sm text-text-secondary dark:text-gray-400 transition-colors hover:text-secondary"
                                >
                        ...
                        <div>
                            ...
                            <div className="mt-4 space-y-3 text-sm text-text-secondary dark:text-gray-400">
                                ...
                                <p>Shantinagar Moar, Bailly Road, Dhaka</p>
