...
export default function Testimonials() {
    ...
    const reviewerMeta = [
        { name: 'Rafiqul Islam', roleAndLoc: 'Passport Applicant · Gulshan Branch', initial: 'R', color: 'bg-violet-600' },
        { name: 'Tasnim Hossain', roleAndLoc: 'Corporate Mug Order · Bailey Road Branch', initial: 'T', color: 'bg-rose-600' },
        { name: 'Arif Hasan', roleAndLoc: 'Urgent Visa Application · Bailey Road Branch', initial: 'A', color: 'bg-amber-600' },
        { name: 'Sumaiya Rahman', roleAndLoc: 'Schengen Visa · Gulshan Branch', initial: 'S', color: 'bg-cyan-600' },
        { name: 'Farhana Begum', roleAndLoc: 'Parent — School Admission · Bailey Road Branch', initial: 'F', color: 'bg-pink-600' },
        { name: 'Kamal Hossain', roleAndLoc: 'Parent — ID Card Photo · Gulshan Branch', initial: 'K', color: 'bg-indigo-600' },
    ];

    const reviews = reviewerMeta.map((meta, i) => ({
        ...meta,
        rating: 5,
