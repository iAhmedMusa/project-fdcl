                    ...
                    <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
                        ...
                        <div>
                            ...
                            <ul className="space-y-2.5">
                                {[
                                    { label: t.footer.passportPhoto, href: WHATSAPP_URL },
                                    { label: t.footer.visaPhoto, href: WHATSAPP_URL },
                                    { label: t.footer.photoReprint, href: WHATSAPP_URL },
                                    { label: t.footer.photoAlbum, href: WHATSAPP_URL },
                                    { label: t.footer.photoFrame, href: WHATSAPP_URL },
                                    { label: t.footer.mugPrint, href: WHATSAPP_URL },
                                ].map((link) => (
